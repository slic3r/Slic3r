    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
{
    ...
    this->logo = wxBitmap(VAR_PATH + "/Slic3r_192px.png", wxBITMAP_TYPE_PNG);
...
void
AboutDialogLogo::onRepaint(wxEvent &event)
{
    wxPaintDC dc(this);
...
void
AboutDialog::onLinkClicked(wxHtmlLinkEvent &event)
{
...
void
AboutDialog::onCloseDialog(wxEvent &)
{
