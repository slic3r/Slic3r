...
PrintConfigDef::PrintConfigDef()
{
    ...
    def = this->add("min_bridge_density", coPercent);
    def->gui_type = "f_enum_open";
    def->gui_flags = "show_value";
    def->label = "Minimum Solid Bridge";
    def->category = "Infill";
    def->tooltip = "Fill \% lower than this will get bridge layer/flow over it. Expressed in the range 0% - 100%.";
    def->sidetext = "%";
    def->cli = "min-bridge-density=s";
    def->min = 0;
    def->max = 100;
    def->enum_values.push_back("0");
    def->enum_values.push_back("5");
