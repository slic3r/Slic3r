...
class LayerRegion
{
    ...
    SurfaceCollection slices;   ///< collection of surfaces generated by slicing the original geometry
                                ///< divided by type top/bottom/internal

    ExtrusionEntityCollection thin_fills;   ///< collection of extrusion paths/loops filling gaps

    SurfaceCollection fill_surfaces;    ///< collection of surfaces for infill generation

    Polygons bridged;   ///< collection of expolygons representing the bridged areas (thus not
                        ///< needing support material)

    PolylineCollection unsupported_bridge_edges;    ///< collection of polylines representing the unsupported bridge edges

    ExtrusionEntityCollection perimeters;   ///< ordered collection of extrusion paths/loops to build all perimeters
                                            ///< (this collection contains only ExtrusionEntityCollection objects)

    ExtrusionEntityCollection fills;    ///< ordered collection of extrusion paths to fill surfaces
                                        ///< (this collection contains only ExtrusionEntityCollection objects)
